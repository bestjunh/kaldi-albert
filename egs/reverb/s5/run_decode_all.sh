...
# AlgName=WPEOverIVA_v3.1.2
AlgName=CDRWPEOverIVA_v2.6.0
# AlgName=CDRSVDWPEOverIVA_v0.3.1
                            ...
                            for nIter in 1; do
                                for mod_wpe_frame in 1 5;do
                                    for wavIter in 1 2;do                                        
                                        ./run_decode_v2.sh $AlgName $wavIter 'lambda_scale_'$lambda_scale'_lambda_unit_'$lambda_unit'_lambda_null_'$lambda_null'_D_'$D'_L_'$L'_delta_'$delta'_wpe_delta_'$wpe_delta'_nIter_'$nIter'_mod_wpe_frame_'$mod_wpe_frame
                                    done
                                done
                            done
                        done
